...
#'Data (version updated on June 1, 2020). Downloaded on August 25, 2020 from
#'https://collegescorecard.ed.gov/data/ .
#'
#'  Some of the variables in the book data have been
#'calculated from other variables in the original source; these have been given new variable
#'names that are not found in the data dictionary at
#'https://collegescorecard.ed.gov/data/documentation/ .
#'
#'The college data set contains only colleges in the 50 states plus District of Columbia
#'that offer undergraduate degrees and contain information on average net price.
#' This data set is made available for pedagogical purposes only. Anyone wishing to draw
#' conclusions from College Scorecard data should obtain the original data set from the 
#'   Department of Education. The original data set has 1,925 variables and includes institutions
#' (such as those that do not grant undergraduate degrees) that are not in the data
#' college. 
...
#' between 14 and 22 (these offier Bachelor's degrees), (7) enrolls first-time
...
#'\}
#'
#'hbcu: Historically black college or university, 1=yes, 0 = no
#'
#'openadmp: Does the college have an open admissions policy, that is,does it accept any students that apply or have minimal requirements for admission? 1 = yes, 0 = no
#'
...
#'
#'ugds: Number of number of degree-seeking undergraduate students enrolled in the fall term
#'
